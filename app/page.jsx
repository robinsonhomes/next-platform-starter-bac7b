        ...
        <div className="flex flex-col">
            ...
            <section className="relative overflow-hidden">
                ...
                <div className="relative max-w-6xl mx-auto px-6 sm:px-8 py-20 sm:py-28">
                    <div className="text-center mb-16">
                        <p className="text-brand-gold/70 text-sm font-semibold tracking-widest uppercase mb-3">Testimonials</p>
                        <h2 className="mb-4 text-white/70 !text-xl sm:!text-2xl lg:!text-3xl">What Our Clients Say</h2>
                        <div className="section-divider mt-6" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="p-8">
                            <div className="flex gap-1 mb-4">
                                {[...Array(5)].map((_, i) => (
                                    <svg key={i} xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-brand-gold/70" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <p className="font-semibold text-white/70 text-sm" style={{ fontFamily: 'var(--font-display)' }}>
