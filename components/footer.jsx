                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li>
                                <Link href="/" className="text-gray-500 no-underline hover:text-brand-navy transition-colors">
                                    Home
                                </Link>
                            </li>
                            <li>
                                <Link href="/about" className="text-gray-500 no-underline hover:text-brand-navy transition-colors">
                                    About
                                </Link>
                            </li>
                            <li>
                                <Link href="/properties" className="text-gray-500 no-underline hover:text-brand-navy transition-colors">
                                    Properties
                                </Link>
                            </li>
                            <li>
                                <Link href="/contact" className="text-gray-500 no-underline hover:text-brand-navy transition-colors">
                                    Contact
                                </Link>
                            </li>
                        </ul>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li>
                                <a
                                    ...
                                    className="text-gray-500 no-underline hover:text-brand-navy transition-colors flex items-center gap-2"
                                >
